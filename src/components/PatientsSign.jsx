 ...
 function SignIn() {
      ...
      <h3 className="text-4xl font-bold mb-px">Patients Login</h3>
    </div>
            <div className="flex justify-center items-center m-4 mr-10 p-10 sm:flex-row sm:items-end sm:gap-3 "> 
              <div className="flex flex-col-reverse gap-5 sm:flex-row">
                    <div className="flex flex-col justify-center items-center sm: -mt-20">
                        ...
                        <input type="text" placeholder="0x0000" className=" rounded-lg h-8 w-54 p-4 text-left"/><br /><br />
                        <label htmlFor="">Password</label>
                        <input type="password" placeholder="password" className=" rounded-lg h-8 w-54 p-4 text-left"/>
